...
class Client implements ClientInterface
{
    ...
    public function getSearch(SearchQuery $query): SearchResult
    {
        ...
        if ($cached = $this->fetchFromCache($cacheKey)) {
            return $cached;
        }
    ...
    public function getSearchAll(SearchQuery $query): Generator
    {
        ...
        while (true) {
            ...
            $currentItemIds = array_map(fn (Listing $l) => $l->itemId, $result->listings);
    ...
    public function getMotorcycleBrandCatalog(): MotorcycleBrandCatalog
    {
        ...
        if ($cached = $this->fetchBrandCatalogFromCache($cacheKey)) {
            return $cached;
        }
