...
class ListingFactory
{
    ...
    public static function make(array $overrides = []): Listing
    {
        $defaults = [
            ...
            'title' => 'Test Desk Listing',
            'description' => 'A great desk for sale.',
            'categorySpecificDescription' => null,
            'categoryId' => 51,
            'vipUrl' => '/v/huis-en-inrichting/bureaus/m1234567890',
            'fullUrl' => 'https://www.marktplaats.nl/v/huis-en-inrichting/bureaus/m1234567890',
            'priceInfo' => null,
            'location' => null,
            'imageUrls' => [],
            'pictures' => [],
