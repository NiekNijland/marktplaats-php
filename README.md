# This is my package marktplaats-php
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/marktplaats-php.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/marktplaats-php)
...
```php
$skeleton = new NiekNijland\Marktplaats();
echo $skeleton->echoPhrase('Hello, NiekNijland!');
```
